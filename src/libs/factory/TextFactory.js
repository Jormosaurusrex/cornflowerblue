class TextFactory {
    ...
    static get _libraryBase() {
        return {
            ...
            "datagrid-dialog-item-delete": "Delete $",
            "datagrid-dialog-item-edit-instructions": "Fill out the form below.",
            "datagrid-dialog-item-edit-passiveinstructions": "You can edit this $1",
